...
#define BSP_ALTBASE_ADDR(_addr) (((u32)_addr) - wafel_plugin_base_addr + BSP_ALT_BASE)
#define KERN_ALTBASE_ADDR(_addr) (((u32)_addr) - wafel_plugin_base_addr + KERN_ALT_BASE)
